...
const plans = [
  {
    ...
    priceId: "",
    amountInPaise: 0,
    features: ["5 Workout Plans", "Basic Progress Tracking", "Community Access", "Exercise Library"],
    highlight: false,
    icon: Star,
  },
  {
    ...
    features: [
      ...
      "Strength, HIIT & Yoga Programs",
      "AI Fitness Chatbot",
      "BMI & Calorie Calculator",
      "Full Nutrition Guide & Meal Plans",
      "Advanced Analytics",
      "Custom Meal Plans",
      "Priority Support",
      "Offline Mode",
  ...
  return (
    <section id="premium" className="py-24 hero-gradient">
      <div className="container">
        ...
        >
          <span className="text-primary text-xs font-semibold tracking-widest uppercase">Premium Plans</span>
