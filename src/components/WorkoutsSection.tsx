  ...
  return (
    <section id="workouts" className="py-24 bg-background">
      <div className="container">
        ...
        >
          <span className="text-primary text-xs font-semibold tracking-widest uppercase">Programs</span>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4 space-y-2">
                    {w.exercises.map((ex) => (
                      <div key={ex} className="text-sm text-secondary-foreground flex items-center gap-2">
                  ...
                  <button
                    onClick={() => handleStart(w.slug)}
                    className="mt-6 w-full py-3 rounded-lg bg-primary text-primary-foreground font-semibold text-sm hover:opacity-90 transition-opacity"
                  >
                    Start Workout
                  </button>
                </div>
